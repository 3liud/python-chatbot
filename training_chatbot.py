...
for doc in documents:
    ...
    pattern_words = doc[0]
    # lemmatize each word - create base word, in attempt ot represet related words
    pattern_words = [
        lemmatizer.lemmatize(word.lower()) 
    for word in pattern_words
    ]
    # creates our bag of words array with 1, if word match found in current pattern 
for w in words:
    bag.append(1) if w in pattern_words else bag.append(0)
    # the output is a 0 for each tag and 1 for current tag (each pattern)
